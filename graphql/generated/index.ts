...
export type UsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'users', id: any, name?: string | null | undefined, twitter?: string | null | undefined }> };
...
export const useInfiniteUsersQuery = <
    ...
    useInfiniteQuery<UsersQuery, TError, TData>(
      ...
      (metaData) => useFetchData<UsersQuery, UsersQueryVariables>(UsersDocument).bind(null, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );
